...
export function SEO({
  ...
  useEffect(() => {
    ...
    // 获取页面配置
    const pageConfig = page !== 'home' && seoConfig.games[page] ? seoConfig.games[page] : seoConfig
    ...
    const finalImage = image || `https://qq.cpflying.top${seoConfig.openGraph.images[0].url}`
...
export const SEOPresets = {
  Home: () => <SEO page="home" />,
  Flight: () => <SEO page="flight" url="https://qq.cpflying.top/games/flight" />,
  Minesweeper: () => <SEO page="minesweeper" url="https://qq.cpflying.top/games/minesweeper" />,
  Wheel: () => <SEO page="wheel" url="https://qq.cpflying.top/games/wheel" />,
  Tasks: () => <SEO page="tasks" url="https://qq.cpflying.top/games/tasks" />,
}
