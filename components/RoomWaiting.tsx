...
export const RoomWaiting: React.FC<RoomWaitingProps> = ({
    ...
    const copyRoomId = async () => {
        try {
            ...
            Alert.alert(
                t('common.error', '错误'),
                t('online.copyFailed', '复制失败，请手动复制房间代码')
            );
        }
    };
                    ...
                    <View style={styles.roomHeader}>
                        <View style={styles.roomTitleContainer}>
                            <View style={styles.roomCodeContainer}>
                                ...
                                <Text style={[styles.roomCode, {color: colors.settingsAccent}]}
                                      onPress={() => copyRoomId()}>
                                    {roomId.toUpperCase()}
                                </Text>
                            </View>
                                        ...
                                        <>
                                            ...
                                            <View style={styles.playerInfo}>
                                                <View style={styles.playerNameRow}>
                                                    ...
                                                    {player.isHost && (
                                                        <View
                                                            style={[styles.hostBadge, {backgroundColor: '#FFD700' + '20'}]}>
                                                ...
                                                <View style={styles.connectionStatus}>
                                                    ...
                                                    <Text
                                                        ...
                                                        {player.isConnected ? t('online.connected', '已连接') : t('online.disconnected', '已断线')}
                                                    </Text>
                                                </View>
                                            </View>
                                        </>
                        ...
                        >
                            ...
                            >
                                ...
                                <Text style={styles.startGameText}>
                                    {canStartGame ? t('online.startGame', '开始游戏') : t('online.waitingPlayers', '等待玩家')}
                                </Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    ) : (
