...
示例:
  ...
  start 2 wheel           - 创建2个机器人玩转盘游戏
  add-bot Player_X        - 添加名为Player_X的机器人
        `);
    }
...
机器人列表:`);
        ...
        status.bots.forEach((bot, index) => {
            ...
            console.log(`  ${index + 1}. ${connectionStatus} ${bot.playerName} ${turnIndicator} (${bot.playerId})`);
        });
    }
